...
namespace DataLayer.Migrations
{
    ...
    [Migration("20200621172700_TransactionHistoryTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.TransactionHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DataLayer.Entities.TransactionHistory", b =>
                {
                    b.HasOne("DataLayer.Entities.ApplicationUser", "Beneficiar")
                        .WithMany("BeneficiarTransactionsHistory")
                    ...
                    b.HasOne("DataLayer.Entities.ApplicationUser", "Sender")
                        .WithMany("SenderTransactionsHistory")
